...
ser_aleria <- upload_csv("ser_aleria_20260801.csv") 
...
seq234 <- c("Horizon - Campanian A", "Lattara US 31195 = 31196")

## lattes - additional stratigraphic / phase sequences
seq235 <- c("Lattara US 35286 = 35303", "Lattara US 35311", "Lattara US 35337")

## horizon - Campanian A
seq236 <- c("Horizon - Campanian A", "Lattara US 35476")
...
contexts_20260801 <- list(
  ...
  seq228, seq229, seq230, seq231, seq232, seq233, seq234, seq235, seq236
)
